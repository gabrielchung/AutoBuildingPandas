...
Invoke-WebRequest -URI $SOURCE_CODE_URL -OutFile $DOWNLOAD_DEST_PATH
...
$TMP_SOURCE_DIR_PATH = "."
Expand-Archive -Path $DOWNLOAD_DEST_PATH -DestinationPath $TMP_SOURCE_DIR_PATH
...
docker exec my-pandas-dev-container /home/pandas/script_to_be_run_inside_the_container.sh
